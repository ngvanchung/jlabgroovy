...
// Calculates the logP of a State
public class Plog {
  double[] dat;   // Bind to data vector
  int ndat;
  double[] stau, slogtau;

  // Constructor. Digest the data vector for subsequent fast calculation of logP. The data are assumed to
