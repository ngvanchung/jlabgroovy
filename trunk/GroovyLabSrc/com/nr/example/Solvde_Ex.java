...
/* 
 Sample program for Solvde 
 Computes eigenvalues of spheroidal harmonics Smn(x;c) for m >= 0 and n >= m.
 In the program, m is mm, c^2 is c2, and gamma pf equation (18.4.20) is anorm
 */
